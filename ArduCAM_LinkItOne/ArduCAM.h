...
/*------------------------------------
	...
	2015/09/20  V3.4.8  by Lee	Add support for ESP8266 processor. Tool chain can be download using http://arduino.esp8266.com/stable/package_esp8266com_index.json		
	2015/11/10  V3.5.0  by Lee	Add support for LinkIt ONE board.	Tool chain can be download using http://download.labs.mediatek.com/package_mtk_linkit_index.json						
--------------------------------------*/
